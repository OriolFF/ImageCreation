...
# Precision and RNG device configuration notes:
#   FLUX_DTYPE: "bfloat16" or "fp16" (bfloat16 is ideal for modern NVIDIA GPUs)
#   FLUX_GENERATOR_DEVICE: "cpu" | "auto" | "mps" | "cuda"
#     - Use "cuda" for best throughput on NVIDIA GPUs (e.g., RTX 5080)
